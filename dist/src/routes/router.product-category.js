...
const subcategories_update_1 = __importDefault(require("../controllers/products/categories/subcategories/subcategories.update"));
const subcategories_delete_1 = __importDefault(require("../controllers/products/categories/subcategories/subcategories.delete"));
const subcategories_fetch_one_1 = __importDefault(require("../controllers/products/categories/subcategories/subcategories.fetch-one"));
const categories_fetch_one_1 = __importDefault(require("../controllers/products/categories/categories.fetch-one"));
...
productCategoryRouter.get("/fetch-one", middleware_connection_1.ConnectionMiddleware, categories_fetch_one_1.default);
// subcategories
...
productCategoryRouter.patch("/subcategories/update", middleware_superadmin_1.default, subcategories_update_1.default);
productCategoryRouter.delete("/subcategories", middleware_superadmin_1.default, subcategories_delete_1.default);
productCategoryRouter.get("/subcategories/fetch-one", middleware_connection_1.ConnectionMiddleware, subcategories_fetch_one_1.default);
