...
exports.useProductCreationValidator = void 0;
const static_index_1 = require("../../lib/static/static.index");
const method_string_1 = require("../../helpers/methods/method.string");
const useProductCreationValidator = (data, next) => {
    var _a;
    const { category_id, // required
    product_name, // required
    subcategory_id, quantity, discount, price, district, region, product_images, featured_image, is_negotiable, } = data;
...
exports.useProductCreationValidator = useProductCreationValidator;
