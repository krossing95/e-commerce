...
const signin_google_1 = require("./signin.google");
...
const LoginUsingEmailPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    try {
        ...
        const comparePassword = (0, bcrypt_1.compareSync)(requestBody.password, user.password);
        if (!comparePassword)
            return res.status(400).json({
                message: "Incorrect login credentials",
                code: "400",
        ...
        if (!mfaData.useMfa)
            return yield (0, signin_google_1.login)(loggableUser, res);
...
exports.default = LoginUsingEmailPassword;
